...
You can generate a random file to test this program using the script textgen.sh.  
Example: `./textgen.sh number`  creates a file *rand.txt* where `number` is the size of the file(i.e. the number or characters) in MegaBytes.
